...
function ComandaEditor({ comanda, servicos, produtosBar, produtosLoja, onFinalizar, onRemover, onAutosave }) {
...
function ComandaCard({ comanda, aberta, onToggle, servicos, produtosBar, produtosLoja, onFinalizar, onRemover, onAutosave }) {
